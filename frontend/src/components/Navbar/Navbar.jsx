  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-slate-200/60 bg-white/80 px-8 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-5">
        ...
        <button className="rounded-2xl bg-slate-100 p-3 transition hover:bg-blue-500 hover:text-white">
        ...
        <button className="rounded-2xl bg-slate-100 p-3 transition hover:bg-indigo-500 hover:text-white">
        ...
        <div className="flex items-center gap-3 rounded-2xl bg-slate-100 px-3 py-2">
          ...
          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-500 text-lg font-bold text-white">
